<template>
  <div class="main" :style="{width:screenWidth}">
    <el-row class="row">
      <el-col :span="8" class="market" :key=index v-for="(item,index) in market">
        ...
        <div class="market-one">
          ...
          <h3 class="title">{{item.marketName}}</h3>
          <p>
            <span>维护成本:</span>
            ...
            <el-dialog title="修改市场基本信息" :visible.sync="modify">
              <el-form>
                ...
                <el-form-item label="市场名称" :label-width="formLabelWidth">
                  ...
                  <el-input v-model="marketName" autocomplete="off"></el-input>
                </el-form-item>
  ...
  methods:{
    ...
    addMarket(){
      ...
      let postData = JSON.stringify({
        ...
        marketName: this.inputs[1].value,
        marketResearchCost: this.inputs[2].value,
        marketResearchPeriod: this.inputs[3].value,
